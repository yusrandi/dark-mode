import { View, Text, Switch, useColorScheme, TouchableOpacity, ScrollView, SafeAreaView, Image, FlatList, StyleSheet } from 'react-native'
    ...
    function Header() {
        return (
            <View style={{ paddingHorizontal: 24, flexDirection: "row", alignItems: "center", gap: 8 }}>
                ...
                >
                    <Icons name="twitter" size={24} color={colors.text} />
                </TouchableOpacity>
            </View>
        )
    }
